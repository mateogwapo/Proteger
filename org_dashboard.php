...
<head>
  ...
  <title>Protéger | Health Center - Dashboard</title>
...
<!--       <div class="form-inline">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <i class="nav-icon fab fa-dashcube"></i>
          ...
          <li class="nav-item">
            <a href="pages/examples/org_activity.php" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
            ...
            <div class="small-box bg-info">
              ...
              <a href="#exampleModalclothes" data-toggle="modal" data-target="#exampleModalclothes" class="small-box-footer">Click here to proceed <i class="fas fa-arrow-circle-right"></i></a>
               ...
               <!-- <button type="button" class="small-box-footer" data-toggle="modal" data-target="#exampleModalclothes" a href="#exampleModalclothes">Click here to proceed <i class="fas fa-arrow-circle-right"></i></button> -->
                ...
                <h2 id="heading">Donate PPE</h2>
                <p>Please fill out details</p>
                <form id="msform" role="form" method="post" action="">
                    <!-- progressbar -->
                    <ul id="progressbar">
                    ...
                    <fieldset>
                        <div class="form-card">
                            ...
                            <label class="fieldlabels">Name: *</label> <input type="name" name="name" placeholder="<?php echo $name;?>" /> 
                            <label class="fieldlabels">Age: *</label> <input type="number" name="age" placeholder="Age" />
                            <label class="fieldlabels">Sex: *</label>
                            <div class="custom-control custom-radio mb-3">
                              <input type="radio" id="radiomale" name="customRadio" class="custom-control-input">
                              <label class="custom-control-label" for="radiomale">Male</label><br>
                            </div>
                            <div class="custom-control custom-radio mb-3">
                              <input type="radio" id="radiofemale" name="customRadio" class="custom-control-input">
                            ...
                            <label class="fieldlabels">Contact No: *</label> <input type="tel" name="contactno" placeholder="+63 XXX XXX-XXXX"/>
                            <label class="fieldlabels">Email: *</label> <input type="email" name="mail" placeholder="<?php echo $email;?>"/>
                  ...
                  ?>
                    <fieldset>
                        <div class="form-card">
                            <div class="row">
                                <div class="col-7">
                                    <h2 class="fs-title"> PPE Items:</h2>
                                </div>
                                <div class="col-5">
        ...
        while($row = mysqli_fetch_array($result))
        {
          ?>
                            <div class="custom-control custom-checkbox mb-3">
                              <input class="matt" id="checkboxitemTopsi" type="checkbox" name="goods[]" value="<?php echo $row['itemName'];?>" onclick="displayinputFunction1()">
                              <label class="custom-control-label" for="checkboxitemTopsi" ><?php echo $row['itemName'];?></label>
                              <!-- Quantity Appear -->
                              <input id="hiddenTopsin" style="display: none" type="number" name="topsinfQuant" placeholder="quantity (pcs)" for />
                              <script>
                                function displayinputFunction1() {
                                  var checkBox = document.getElementById("checkboxitemTopsi");
                                  var text = document.getElementById("hiddenTopsin");
      ...
      if(isset($_POST['closub']))  
{  

            $age = $_POST['age1'];
            $sex = $_POST['customRadio1'];
...
$db_name="db_system";//database name  
$con=mysqli_connect("$host", "$username", "$password","$db_name")or die("cannot connect");//connection string  
$checkbox1=$_POST['goods'];  
$chk="";  
foreach($checkbox1 as $chk1)  
   {  
      $chk .= $chk1.",";  
   }  
$in_ch=mysqli_query($con,"insert into tbldonor (donorName,Age,Sex,Address,Contact,Email,Goods,Quantity) values ('$name', '$age', '$sex', '$address', '$contact', '$email','$chk', '$quantity1')");  
if($in_ch==1)  
   {  
...
return false;
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="pages/examples/org_activity.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="pages/examples/org_profile.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
