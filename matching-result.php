...
<head>
  ...
  <title> Protéger | Matching Result</title>
...
<div class="login-box">
  ...
  <div class="card card-outline card-success">
    <div class="card-header text-center">
      <a class="h1"><b>Matching Result</b></a>
    </div>
    <div class="card-body">
      <div class="justify-content-center text-center">
          ...
          <br>  <p class="login-box-msg">Please read the instruction below :</p>
        ...
        <div class="input-group mb-3 ">
          <p class=""><b> 1.)</b> Hi <b><?php echo $username ?></b>, Please proceed to your nearest barangay hall, along with your goods to be donated. </p>
          <p class=""><b>2.)</b> Present this Reference Code to our staff <b> 6850718<?php echo $id ?> </b> </p>
          <p class=""><b>3.)</b> We'll send you a notification, once we recieved your donation!</p>
        </div>
      <?php } ?>
        <div class="row">
          <div class="col-8">
          ...
          <!-- /.col -->
          <div class="col">
            <a href= "user_dashboard.php" class="btn btn-success btn-block">Proceed to Dashboard</a>
          </div>
          <!-- /.col -->
        </div>
