...
<!--     <button class="btn btn-primary dropdown-toggle" data-sort="none"><i class="fa fa-sort"></i></button> -->
      ...
      <li><a href="category.php" tabindex="-1" data-type="alpha">&nbsp; Category</a></li>
      <li><a href="stock.php" tabindex="-1" data-type="numeric">&nbsp; Stock #</a></li>
    </ul>
        ...
        <div class="card-body p-0">
          <table class="table table-striped projects">
              ...
              if(mysqli_connect_errno())
                ...
                $query="SELECT * FROM tblitems ORDER BY itemCategory ASC";
