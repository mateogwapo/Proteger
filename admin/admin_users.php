          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
              	<form class="formValidate" id="formValidate1" method="post" action="../config/user_router1.php" novalidate="novalidate">
                <h3 class="card-title">Manage Users</h3>
                  <div class="project-actions text-right">
              <a href="add_healthcenter.php" class="btn btn-success btn-sm"><i class=" nav-icon fas fa-plus-circle"></i>&nbsp; Add Health Center</a>
              ...
              <div class="card-body">
                <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                       <?php
        $result = mysqli_query($con, "SELECT * FROM users where role ='Organization'");
        while($row = mysqli_fetch_array($result))
