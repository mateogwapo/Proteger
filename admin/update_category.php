...
$query="select * from tblcategoryforitems where id='$update_details'";
      ...
      <!-- Default box -->
        <div class="col-md-6">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <form action="update_category.php?update_form=<?php echo $update_details; ?>" method="post">
...
<!-- jQuery -->
    ...
    $queryu="update tblcategoryforitems set categoryname='$Categoryname', category_desc='$Categorydesc', date=NOW() where id='$update_id'";
