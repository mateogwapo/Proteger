...
<div class="login-box position ">
  ...
  <div class="card card-outline card-primary primary1">
    ...
    <div class="card-body">
      ...
      <form role="form" id="form" method="POST" action="login-router.php">
      ...
      <p class="mb-1" >
        <a href="#modal-default" data-toggle="modal" data-target="#modal-default" class="text-center">Register</a>
      </p>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <h5>These terms and condition govern your access to and use of
                  the Proteger website. Please read these terms, carefully, and contact us if you have question and concern.</h5><br>
                  <p>By accessing or using Proteger, and clicking the “agree” button herein as an expressed 
                  consent and approval for the collection and processing of my personal data in accordance to the Intellectual Property Code and Data Privacy Law.</p>
              ...
              <input type="checkbox" name="terms" id="terms" onchange="activateButton(this)"> I Agree to the Terms & Conditions<br><br>
                 <a href="register.php"><input class="btn btn-primary" type="submit" value="Proceed" id="submit"></a>
