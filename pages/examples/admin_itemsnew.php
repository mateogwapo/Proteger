              ...
              <tbody>
                  <tr>
                      ...
                      <td class="project-actions text-right">
                          <a class="btn btn-primary btn-sm" href="devItemdetails.php?devitemdetails=<?php echo $id;?>">
                          ...
                          <a class="btn btn-danger btn-sm" href="../../delete_item.php?deleteid=<?php echo $id; ?>" data-confirm="Are you sure you want to delete this item?">
              ...
              <tbody>
                  <tr>
                      ...
                      <td class="project-actions text-right">
                          ...
                          <a class="btn btn-danger btn-sm" href="../../delete_category.php?deleteid=<?php echo $id; ?>" data-confirm="Are you sure you want to delete this item?">
                              <i class="fas fa-trash">
                              </i>
                              Delete
                          </a>
