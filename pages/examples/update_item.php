...
$query="select * from tblitems where id='$update_details'";
      ...
      <!-- Default box -->
        <div class="col-md-6">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <form action="update_item.php?update_form=<?php echo $update_details; ?>" method="post">
              <div class="form-group">
               ...
               ?>"
               id="itemID" placeholder="Enter item ID" required>
              </div>
              <div class="form-group">
...
<script src="../../dist/js/pages/dashboard.js"></script>
 <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDTTfWur0PDbZWPr7Pmq8K3jiDp0_xUziI"></script>
    ...
    $queryu="update tblitems set itemName='$itemname', itemCategory='$category', item_stock='$itemstock', itemDescription='$itemdescription', date=NOW() where id='$update_id'";
    if(mysqli_query($con,$queryu))
    {
    echo "<script>alert('Details Updated')</script>";
    echo "<script>location.href='admin_itemsnew.php'</script>";
    }
    else
    {
