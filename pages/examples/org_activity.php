    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-header"></li>
          <li class="nav-header"></li>
          <li class="nav-header"></li><br><br><br>
              ...
              <div class="card-body">
                <table class="table table-bordered table-hover">
                  ...
                  <?php
                    ...
                    $query="SELECT * FROM tbldonorgcat";
                    $run=mysqli_query($con,$query);
                    while ($row=mysqli_fetch_array($run)) {
                      $id=$row['donOrgCatID'];
                      $firstName=$row['donorID'];
                      $lastName=$row['organizationID'];
                      $email=$row['itemName'];
                    ?>
                  ...
                  <tbody>
                    <tr data-widget="expandable-table" aria-expanded="false">
                      ...
                      <td><a href="../../delete.php?deleteid=<?php echo $id; ?>" class="badge badge-danger delme" data-confirm="Are you sure you want to delete this item?">Delete</a></td>
                    </tr>
