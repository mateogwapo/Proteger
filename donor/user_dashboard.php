            ...
            <div class="small-box bg-info">
              ...
              <a href="#exampleModalclothes" data-toggle="modal" data-target="#exampleModalclothes" class="small-box-footer">Click here to proceed <i class="fas fa-arrow-circle-right"></i></a>
               ...
               <!-- <button type="button" class="small-box-footer" data-toggle="modal" data-target="#exampleModalclothes" a href="#exampleModalclothes">Click here to proceed <i class="fas fa-arrow-circle-right"></i></button> -->
                ...
                <form id="msform" role="form" method="post" action="../config/useradd.php">
                    <!-- progressbar -->
                    <ul id="progressbar">
                    ...
                    <fieldset>
                        <div class="form-card">
                            ...
                            <label class="fieldlabels">Name: *</label> <input type="name" name="donorName" value="<?php echo $name;?>" /> 
                            <label class="fieldlabels">Age: *</label> <input type="number" name="Age" value="Age" />
...
<fieldset>
        ...
        while($row = mysqli_fetch_array($result))
        {
          ...
          echo '<input placeholder="Please Enter Quantity" id="'.$row["id"].'" name="'.$row['id'].'" onchange="checknumber type="text" data-error=".errorTxt'.$row["id"].'><div class="errorTxt'.$row["id"].'"></div></td></tr>';
        }
          ?>
...
return false;
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="user_activity.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
