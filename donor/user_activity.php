...
<head>
  ...
  <title>AdminLTE 3 | User Activity</title>
</head>
<?php
include 'header.php'
?>
          ...
          $run=mysqli_query($con,$query);
                  ...
                  <tbody>
                    <tr data-widget="expandable-table" aria-expanded="false">
                      ...
                      <td><a href="../config/delete.php?deleteid=<?php echo $id; ?>" class="badge badge-danger delme" data-confirm="Are you sure you want to delete this item?">Delete</a></td>
                    </tr>
                  </tbody>
                <?php } ?>
                </table>
