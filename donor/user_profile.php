              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal" method="post" action="../config/details-router.php" novalidate="novalidate">
                      ...
                      <div class="form-group row">
                        <label for="input-last-name" class="col-sm-2 col-form-label">Barangay</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="input-barangay" placeholder="Barangay" name="Barangay" value="<?php echo $barangay;?>">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="input-last-name" class="col-sm-2 col-form-label">City</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="input-city" placeholder="City" name="City" value="<?php echo $city;?>">
                        </div>
                      </div>
                      <div class="form-group row">
...
<div class="modal fade" id="uploadPhoto">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="../config/changeProfile.php" method="post" enctype="multipart/form-data">
