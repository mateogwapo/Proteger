...
<!--     <button class="btn btn-primary dropdown-toggle" data-sort="none"><i class="fa fa-sort"></i></button> -->
      ...
      <li><a href="#" tabindex="-1" data-type="alpha">&nbsp; Item Name</a></li>
      <li><a href="#" tabindex="-1" data-type="alpha">&nbsp; Category</a></li>
      <li><a href="#" tabindex="-1" data-type="numeric">&nbsp; Stock #</a></li>
    </ul>
          ...
          <table class="table table-striped projects">
              <thead>
                  <tr>
                      ...
                      <th style="width: 20%"><a class="column_sort" id="name" data-order="desc" href="#">
                          Item Name</a>
                      </th>
                      <th style="width: 10%"class="text-center" ><a class="column_sort" id="category" data-order="desc" href="#">
                          Item Category</a>
                      </th>
                      <th style="width: 30%" class="text-center">
                          Description
                      </th>
                      <th style="width: 5%" class="text-center"><a class="column_sort" id="stock" data-order="desc" href="#">
                          Stock #</a>
                      </th>
